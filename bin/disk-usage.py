...
parser.add_argument('-u', '--usage-files', type=str,
                    default='/tmp/global2/disk-usage,/ebio/abt3_projects/disk-usage,/ebio/abt3_projects2/disk-usage,/ebio/abt3/disk-usage,/ebio/abt3_scratch/disk-usage',
                     help='comma delim list of path to disk-usage file(s) (default: %(default)s)')
parser.add_argument('-l', '--label', type=str,
                    default='tmp-global2,abt3-projects,abt3-projects2,abt3-home,abt3-scratch',
